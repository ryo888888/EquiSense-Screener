...
st.warning(
    """
    **免責事項**\n
    本アプリケーションは、投資判断の参考となる情報の提供を目的としたものであり、投資勧誘を目的としたものではありません。
    表示されるデータは、情報提供元から取得したものであり、その正確性、完全性を保証するものではありません。
    本アプリケーションの情報に基づいて被ったいかなる損害についても、作成者は一切の責任を負いません。
